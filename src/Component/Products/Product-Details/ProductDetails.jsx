            ...
            return (
              <>
                <div className="md:flex ">
                  ...
                  <div className="xs:flex-col md:ml-[750px] md:p-6 md:fixed xs:bg-[#f1efef] xs:p-2 sm:px-3 md:bg-[#f1efef] md:rounded-xl">
                    {/* {item &&
                          ...
                          return (
                            <>
                              <div className="xs:text-sm xs:text-left sm:mt-2  md:text-left  ">
                                ...
                                <div className="flex flex-row gap-4 mt-2 sm:mt-5 md:bg-[#f1efef]">
                                ...
                                <div>
                                  {item.variants.some(
                                    ...
                                    <p className="md:bg-[#f1efef] text-orange md:text-[11px]  mt-4 pb-4 sm:mb-4 s  xs:text-xs text-sm md:text-lg font-medium sm:text-2xl">
                                      Out of stock
                                    </p>
                                  )}
                                </div>
